...
namespace Lab10_Okoronko_ver2
{
    ...
    class Program
    {
        ...
        static int[,] MatrixSumma(int[,] matrixA, int[,] matrixB)
        {
        ...
        static void Main()
        {
            Console.Title = "математические действия с матрицами";
            try
            {
                ...
                Console.WriteLine("Результат производения двух матриц:");
                PrintMatrix(result1);

                var result2 = MatrixSumma(a, b);
                Console.WriteLine("Результат сложения двух матриц: ");
                PrintMatrix(result2);

                var result3 = MatrixMinus(a, b);
                Console.WriteLine("Рузультат вычитания двух матриц:");
                PrintMatrix(result3);
                // нулевая матрица
